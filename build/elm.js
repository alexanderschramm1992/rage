...
var $author$project$Main$decodeBeruf = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Beruf,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'gegenstand', $elm$json$Json$Decode$string));
var $author$project$Main$D10 = 3;
var $author$project$Main$D12 = 4;
var $author$project$Main$D20 = 5;
var $author$project$Main$D4 = 0;
var $author$project$Main$D6 = 1;
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Main$decodeWürfel = A2(
	...
	function (typ) {
		switch (typ) {
			...
			default:
				return $elm$json$Json$Decode$fail('Würfel kann nicht ermittelt werden: ' + typ);
		}
	},
...
var $author$project$Main$decoder = A7(
	...
	A2($elm$json$Json$Decode$field, 'weisheit', $author$project$Main$decodeWürfel),
...
var $author$project$Main$encodeBeruf = function (beruf) {
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('D10'))
					]));
		case 4:
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('D12'))
					]));
		default:
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('D20'))
					]));
	}
};
